...
conn.fakeReply = (jid, caption, fakenumber, fakeNumber, fakeCaption) => {
conn.sendMessage(jid, { text: caption }, {quoted: { key: { fromMe: false, participant: fakeNumber, ...(m.chat ? { remoteJid: m.chat } : {}) }, message: { conversation: fakeCaption }}})
}
/**
* @param {*} jid
* @param {*} image
