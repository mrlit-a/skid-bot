...
conn.sendCartMessage = async (jid, text, articuleCount, orderTitle, itemCount, image) => {
var messa = await prepareWAMessageMedia({ image: image }, { upload: conn.waUploadToServer })
