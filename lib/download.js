...
async function videoyt(url, mek, conn, from, user) {
  try {
    ...
    if (videoFormat) {
      ...
      await conn.sendMessage(from, { text: caption, contextInfo: { externalAdReply: { title: `${title}`, body: '', thumbnailUrl: thumbnailUrl, sourceUrl: "wa.me/+528442114446", mediaType: 1, showAdAttribution: false, renderLargerThumbnail: true } } });
